% Weighted Priority Replication Scheme (WPRS)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if FileFindFlag==0
            ...
            if Find==1
                ...
                if FileSize<=RemainderFileSize
                    ...
                    Files=[]; % File_Index | FVi
                    Files_Index=0;
                    
                    MR=0;
                    for i=1:Site1_Files_Index
                        if Site1_Files(i,2)>MR
                            MR=Site1_Files(i,2);
                        end;
                    end;
                    if MR==0
                    ...
                    for i=1:Site1_Files_Index  
                        ...
                        Ci=FileList(Site1_Files(i,1),3);
                        MC=MaximumPrice_File;
                        NRi=Site1_Files(i,2);
                        ETi=RoundNumber-Site1_Files(i,3);
                        
                        if Ti~=0
                            Files(Files_Index,2)=(Alpha*Ci/MC)+(Beta*NRi/MR)+(Gamma*1/ETi);
                        else
                            Files(Files_Index,2)=0;
                        end;
                    end;
            ...
            if Find==1
                ...
                if FileSize<=RemainderFileSize
                    ...
                    for i=1:Site2_Files_Index  
                        ...
                        Ci=FileList(Site2_Files(i,1),3);
                        MC=MaximumPrice_File;
                        NRi=Site2_Files(i,2);
                        ETi=RoundNumber-Site2_Files(i,3);
            ...
            if Find==1
                ...
                if FileSize<=RemainderFileSize
                    ...
                    for i=1:Site3_Files_Index  
                        ...
                        Ci=FileList(Site3_Files(i,1),3);
                        MC=MaximumPrice_File;
                        NRi=Site3_Files(i,2);
                        ETi=RoundNumber-Site3_Files(i,3);
            ...
            if Find==1
                ...
                if FileSize<=RemainderFileSize
                    ...
                    for i=1:Site4_Files_Index  
                        ...
                        Ci=FileList(Site4_Files(i,1),3);
                        MC=MaximumPrice_File;
                        NRi=Site4_Files(i,2);
                        ETi=RoundNumber-Site4_Files(i,3);
